...
<html lang="gl-ES">
    ...
    <body>
            ...
            <section class="blog">
                <?php
                    ...
                    if (!$conexion) {
                        ...
                        $entradasdeblog = "SELECT * FROM blog WHERE Título LIKE 'MENÚ ESCOLAR%' ORDER BY Fecha_Publicación DESC";
                        $resultados = $conexion->query($entradasdeblog);
                        if ($resultados->num_rows == 0) {
                            echo "<p style='color: red;'>Aún no hay entradas publicadas relacionadas con el menú del comedor escolar.</p>";
                        } else {
                            ...
                            do {
                                ...
                                <p class='datapublicacion'>Fecha de publicación: {$row["Fecha_Publicación"]}</p>
                                </article>";
                                $row = $resultados->fetch_assoc();
                                $i++;
                            } while ($row && $i <= 5);
        ...
        <footer>
            ...
            <div class="idiomas">
                <ul>
                    <li><a href="../gl/menuescolar.php">Gallego</a></li>
                    <li><a href="../es/menuescolar.php">Castellano</a></li>
                </ul>
            </div>
            <div class="copyright">
