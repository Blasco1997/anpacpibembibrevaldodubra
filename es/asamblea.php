...
<html lang="gl-ES">
    ...
    <body>
            ...
            <section class="blog">
                <?php
                    ...
                    if (!$conexion) {
                        ...
                        $entradasdeblog = "SELECT * FROM blog WHERE Título LIKE '%ASAMBLEA%' ORDER BY Fecha_Publicación DESC";
                        $resultados = $conexion->query($entradasdeblog);
                        if ($resultados->num_rows == 0) {
                            echo "<p style='color: red;'>Aún no hay entradas publicadas relacionadas con las reuniones de la asamblea.</p>";
                        } else {
        ...
        <footer>
            ...
            <div class="idiomas">
                <ul>
                    <li><a href="../gl/asamblea.php">Gallego</a></li>
                    <li><a href="../es/asamblea.php">Castellano</a></li>
                </ul>
            </div>
            <div class="copyright">
