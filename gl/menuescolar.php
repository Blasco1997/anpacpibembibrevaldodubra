...
<html lang="gl-ES">
    ...
    <body>
            ...
            <section class="blog">
                <?php
                    ...
                    if (!$conexiongl) {
                        ...
                        $entradasdeblog = "SELECT * FROM blog WHERE Título LIKE '%MENÚ ESCOLAR%' ORDER BY Data_Publicación DESC";
                        $resultados = $conexiongl->query($entradasdeblog);
                        if ($resultados->num_rows == 0) {
                            echo "<p style='color: red;'>Aínda non hai entradas publicadas relacionadas co menú do comedor escolar.</p>";
                        } else {
        ...
        <footer>
            ...
            <div class="idiomas">
                <ul>
                    <li><a href="../gl/menuescolar.php">Galego</a></li>
                    <li><a href="../es/menuescolar.php">Castelán</a></li>
                </ul>
            </div>
            <div class="copyright">
